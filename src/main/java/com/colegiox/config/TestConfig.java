...
Exam exam1= new Exam(Instant.parse("2024-04-02T00:00:00Z"),trimester1,teacher5);
		...
		ExamTaken examTaken1= new ExamTaken(student1,exam2,true);
		ExamTaken examTaken2= new ExamTaken(student1,exam3,true);
		ExamTaken examTaken3= new ExamTaken(student1,exam4,true);
		ExamTaken examTaken4= new ExamTaken(student1,exam4,true);
		ExamTaken examTaken5= new ExamTaken(student1,exam5,true);
		ExamTaken examTaken6= new ExamTaken(student1,exam6,true);
		ExamTaken examTaken7= new ExamTaken(student1,exam7,true);
		
		
		examRepository.saveAll(Arrays.asList(exam1,exam2,exam3,exam4,exam5,exam6,exam7,exam8,exam9,exam10));
		examTakenRepository.saveAll(Arrays.asList(examTaken1,examTaken2,
				examTaken3,examTaken4,examTaken5,
				examTaken6,examTaken7));
		schoolClassRepository.saveAll(Arrays.asList(schoolclass1,schoolclass2, schoolclass3));
